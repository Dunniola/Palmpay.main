...
function Bills() {
  return (
   <>
   <div className='bg-black relative top-60 text-center px-10 max-md:px-8 -z-10 m'>
    <h2 className='text-orange-200  text-5xl pt-40 mb-5 font-bold max-md:text-[25px] max-md:relative max-md:bottom-32'>Earn as you spend with rewards </h2>
    <p className='text-orange-50 text-2xl max-md:text-[14px] leading-tight max-md:relative max-md:bottom-28'>With Palmpay, every expense becomes an opportunity to save. Unlock exclusive discounts and cashback rewards with transaction you make. Embrance cashless payment and make every payment count with PalmPay.</p>
