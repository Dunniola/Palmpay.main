...
function Privacy() {
  return (
    <>
    <div className="bg-white relative top-80 flex justify-between px-10  items-center -z-10 text-2xl max-md:flex-col max-md:px-2 md:gap-5">
